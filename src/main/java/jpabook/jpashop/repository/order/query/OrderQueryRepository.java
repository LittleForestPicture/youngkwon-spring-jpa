...
//        return em.createQuery("select new jpabook.jpashop.repository.order.query.OrderFlatDto(o.id, o.name, o.orderDate, o.status, o.address, i.name, oi.orderPrice, oi.count)" +
//                "from Order o" +
//                " join o.member m" +
//                " join o.delivery d" +
